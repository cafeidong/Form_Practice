...
<span class="cstat-no" title="statement not covered" >    props.style = {...element.props.style, ...props.style};</span>
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (props.className &amp;&amp; element.props.className) {
<span class="cstat-no" title="statement not covered" >    props.className = `${element.props.className} ${props.className}`;</span>
  }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Aug 28 2020 21:15:04 GMT-0400 (Eastern Daylight Time)
            </div>
        </div>
