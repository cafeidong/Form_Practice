...
var Month = function Month(_ref) {
  ...
  var _useState = (0, _react.useState)('month'),
      _useState2 = (0, _slicedToArray2.default)(_useState, 2),
      mode = _useState2[0],
      setMode = _useState2[1];

  var disabledMonth = disabledRule.month,
  ...
  }, [disabledDecade, disabledMonth, disabledYear, mode, onChange, onCurrentChange, onDecadeChange, onYearChange, standardCurrent, standardNow, standardRangeValue, standardValue]);
  return /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({}, rest, {
    className: (0, _classnames.default)(cls.wrap, cls.month, className)
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: cls.monthWrap
...
var _default = (0, _CalendarContext.withContext)( /*#__PURE__*/(0, _react.memo)(Month));
