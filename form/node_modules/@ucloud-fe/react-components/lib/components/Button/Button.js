...
var _excluded = ["loading", "icon", "children"];
...
var Button = /*#__PURE__*/function (_PureComponent) {
  ...
  (0, _createClass2.default)(Button, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_style.SButton, (0, _extends2.default)({
        loading: loading
      }, rest), this.renderIcon(), children);
    }
  }]);
  return Button;
...
Button.propTypes = {
  styleType: _propTypes.default.oneOf(['primary', 'border', 'border-gray']),
...
Button.StyleTypes = _shared.StyleTypes;
Button.Sizes = _shared.Sizes;
Button.Shapes = _shared.Shapes;