...
var _default = {
  ...
  // 按钮/投影/默认
  T_BUTTON_PRIMARY_COLOR_SHADOW_DEFAULT: '0 2px 4px -1px #5c76e8, inset 0 -3px 0 0 rgba(0,0,0,0.12), inset 0 1px 0 0 rgba(0,0,0,0.12)',
  // 按钮/投影/hover
  T_BUTTON_PRIMARY_COLOR_SHADOW_HOVER: '0 5px 8px -4px #5c76e8, inset 0 -3px 0 0 rgba(0,0,0,0.12), inset 0 1px 0 0 rgba(0,0,0,0.12)',
  // 按钮/主/文本色
  ...
  // 按钮/次/投影/hover
  T_BUTTON_SECONDARY_COLOR_SHADOW_HOVER: '0 0 1px 0 rgba(0,0,0,0.12),0 8px 12px -4px rgba(0,0,0,0.12),0 2px 1px -1px rgba(0,0,0,0.05), inset 0 -2px 0 0 #e3e9ff',
  // 操作区/间距/下
  ...
  // 抽屉/下边/阴影
  T_DRAWER_SHADOW_BOTTOM: '0 46px 24px -35px rgba(0,0,0,0.05),0 25px 10px -16px rgba(0,0,0,0.05),0 10px 6px -6px rgba(0,0,0,0.05)',
  // 抽屉/左边/阴影
  T_DRAWER_SHADOW_LEFT: '-46px 0 24px -35px rgba(0,0,0,0.05),-25px 0 10px -16px rgba(0,0,0,0.05),-10px 0 6px -6px rgba(0,0,0,0.05)',
  // 抽屉/右边/阴影
  T_DRAWER_SHADOW_RIGHT: '46px 0 24px -35px rgba(0,0,0,0.05),25px 0 10px -16px rgba(0,0,0,0.05),10px 0 6px -6px rgba(0,0,0,0.05)',
  // 抽屉/上边/阴影
  T_DRAWER_SHADOW_TOP: '0 -46px 24px -35px rgba(0,0,0,0.05),0 -25px 10px -16px rgba(0,0,0,0.05),0 -10px 6px -6px rgba(0,0,0,0.05)',
  // 表单项/垂直间距
  ...
  // 块/常规/大
  T_SHADOW_BLOCK_DEFAULT_LG: '0 6px 16px 0 rgba(0,0,0,0.05), 0 16px 24px -8px rgba(0,0,0,0.08), 0 0 16px 0 rgba(0,0,0,0.05),inset 0 -2px 0px 0px rgba(0,0,0,0.08)',
  // 块/常规/中
  T_SHADOW_BLOCK_DEFAULT_MD: '0 0 1px 0 rgba(0,0,0,0.12), 0 8px 12px -4px rgba(0,0,0,0.12), 0 4px 4px -2px rgba(0,0,0,0.05),inset 0 -2px 0px 0px rgba(0,0,0,0.08)',
  // 块/常规/小
  T_SHADOW_BLOCK_DEFAULT_SM: '0 0 2px 0 rgba(0,0,0,0.08), 0 5px 8px -4px rgba(0,0,0,0.12), 0 1px 0 0 rgba(0,0,0,0.05),inset 0 -1px 0px 0px rgba(0,0,0,0.08)',
  // 块/左/大
  ...
  // 按钮/白/hover
  T_SHADOW_BUTTON_HOVER: '0 0 1px 0 rgba(0,0,0,0.12),0 8px 12px -4px rgba(0,0,0,0.12),0 2px 1px -1px rgba(0,0,0,0.05), inset 0 -2px 0 0 #e3e9ff',
  // 按钮/品牌色/默认
  T_SHADOW_BUTTON_PRIMARY: '0 2px 4px -1px #5c76e8, inset 0 -3px 0 0 rgba(0,0,0,0.12), inset 0 1px 0 0 rgba(0,0,0,0.12)',
  // 按钮/品牌色/hover
  T_SHADOW_BUTTON_PRIMARY_HOVER: '0 5px 8px -4px #5c76e8, inset 0 -3px 0 0 rgba(0,0,0,0.12), inset 0 1px 0 0 rgba(0,0,0,0.12)',
  // 内阴影/输入框
